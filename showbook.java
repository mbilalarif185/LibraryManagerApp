...
public class showbook extends JFrame implements ActionListener{
    showbook(String name){
    	...
    	model.insertRow(0, new Object[] {"Name","Author","Publication","Rack"});
        try{
            ...
            while(res.next()) {
            	...
            	if(result.equals(name.toLowerCase())) {
            		...
            		String rack = res.getString(6);
            		model.insertRow(i, new Object[] {name_,author,pub,rack});
            		i++;
            	}
            }
    	}catch(Exception t){
