                ...
                if(res.getString(3).equals(user)){
                    ...
                    while(res2.next()){
                        if(res2.getString(5).equals(res.getString(1))){
                            ...
                            ResultSet res3 = stmt3.executeQuery("SELECT * from Fine WHERE BookId="+Integer.parseInt(res2.getString(4))+" AND MemberId="+Integer.parseInt(res2.getString(5)));
                            while(res3.next()){
                                if((res3.getString(3).equals(res2.getString(4)))&&(res3.getString(4).equals(res2.getString(5)))){
