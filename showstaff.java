...
public class showstaff extends JFrame implements ActionListener{
    showstaff(String name){
    	...
    	model.insertRow(0, new Object[] {"Name","Username","Status","Shift","Designation","Joining Date"});
        try{
            ...
            while(res.next()) {
            	...
            	if(result.equals(name.toLowerCase())) {
            		...
            		model.insertRow(i, new Object[] {name_,username,status,shift,desig,jdate});
            		i++;
            	}
            }
    	}catch(Exception t){
